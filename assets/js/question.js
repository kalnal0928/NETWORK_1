const questions = [
    ...
    },
    {
        ...
        answer: "110000011101",
        explanation: "\n1. 문자 A = 65(10진수) = 01000001(2진수)\n2. 홀수 패리티 비트 계산: 01000001의 1의 개수는 2개(짝수)이므로 패리티 비트는 1\n3. 패리티 비트 포함: 101000001\n4. G(x) = x⁴+x³+x²+1 = 11101(2진수)\n5. CRC 계산: 101000001을 11101로 나눈 나머지를 구합니다.\n6. 최종 결과: 110000011101\n\n계산 과정:\n- 데이터: 101000001 + 0000(CRC 자릿수)\n- 101000001000을 11101로 나누면 나머지는 1101\n- 최종 전송 데이터: 101000001 + 1101 = 110000011101",
        chapter: "네트워크",
        type: "essay"
    }
]
